...
function PieChart() {
  ...
  return (
    <div className="">
      {/* Doughnut chart */}
      <h1 className=" w-[90vw] md:w-[31vw] rounded-2xl text-center bg-white py-4 mb-2 text-black text-xl font-semibold capitalize ">
        Biogas Chart
      </h1>
      <div className="w-[90vw] md:w-[31vw] flex bg-white rounded-2xl p-4">
